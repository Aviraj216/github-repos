...
btn.addEventListener('click', function () {
  let random = Math.floor(Math.random() * quotes.length);  // pick random index
  quote.innerHTML = quotes[random].text;   // put quote text inside .quote element
  writer.innerHTML = '-' + quotes[random].author;  // put author inside .writer element
});
